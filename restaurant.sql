...
CREATE TABLE res_reservation(
  ...
  dinnerTime BIGINT,
  tableId INT,
  FOREIGN KEY(tableId) REFERENCES res_table(tid)
);
INSERT INTO res_reservation VALUES
...
INSERT INTO res_category VALUES
(1, '肉类'),
(2, '海鲜河鲜'),
(3, '丸滑类'),
(4, '蔬菜豆制品'),
...
CREATE TABLE res_dish(
  ...
  detail VARCHAR(128),
  categoryId INT,
  FOREIGN KEY(categoryId) REFERENCES res_category(cid)
);
INSERT INTO res_dish VALUES
...
CREATE TABLE res_order_detail(
  ...
  orderId INT,      /*订单编号*/
  FOREIGN KEY(dishId) REFERENCES res_dish(did),
  FOREIGN KEY(orderId) REFERENCES res_order(oid)
);
INSERT INTO res_order_detail VALUES
(NULL, '50', '2', '丁丁', '100000'),
(NULL, '24', '2', '丁丁', '100001'),
(NULL, '37', '1', '当当', '100002'),
(NULL, '18', '3', '豆豆', '100003'),
